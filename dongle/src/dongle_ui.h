...
/*
 * Скорость печати, символов в минуту, по последним минутам именно печати;
 * -1, пока не набралось ни одной серии. См. typing_speed.c.
 */
int typing_speed_cpm(void);

/*
 * Попросить экран показать свежую скорость. Зовётся на каждое нажатие, когда
 * реально идёт печать, поэтому обязана быть дешёвой; когда перерисовать
 * панель, решает screen.c.
 */
